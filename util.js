...
util.imageVectorToText = function(imageVector, imageSize) {
...
util.textToImageArray = function(text, imageSize) {
  // Split into rows.
  const pixels = [];
...
util.indexToOneHot = function(index, numClasses) {
  const oneHot = [];
...
util.convertDataToTensors = function(data, numClasses) {
